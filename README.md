...
| PostgreSQL | `AT_TIME_ZONE, COUNT_FILTER, DATE_PART, DAY, EXTRACT, GREATEST, HOUR, LEAST, MINUTE, MONTH, OVERLAPS, REGEXP_REPLACE, SECOND, STRING_AGG, TO_CHAR, TO_DATE, YEAR` |
